<html>
	<head>
		<title>Management Standard - WilCode Development</title>
...
<div class="container2">
			<div class="content2">
					<h2>Employee Login</h2>
			         <p>
							<strong> Email:</strong> employee@admin.com &nbsp;&nbsp;|&nbsp;&nbsp;
        ...
        @endif
				...
				<div class="title">
					<h5 style="margin-bottom: 12px"> Management Standard </h5> <p style="font-size: 24px;font-weight: 600">WilCode Development</p>
				</div>
    			
                <br />
                <a href="#" class='btn btn2 btn-lg' onclick="openNav()">Employee Login</a>
                 <a href="{{ URL('/auth/login/') }}" class='btn btn-lg'>Administrator Panel</a>
                 <br /><br />
