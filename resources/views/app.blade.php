...
<html class="no-js" lang="en">
    <head>
       ...
       <link href="{{ asset('/admin/css/app-blue.css?version=2') }}" rel="stylesheet">
       <!--<script>
    ...
    <body>
        <div class="main-wrapper">
            <div class="app" id="app">
                <header class="header">
                    <div class="header-block header-block-collapse "> <button class="collapse-btn" id="sidebar-collapse-btn">
                ...
                <footer class="footer">
                   <!-- <div class="footer-block buttons"> <iframe class="footer-github-btn" src="https://ghbtns.com/github-btn.html?user=modularcode&repo=modular-admin-html&type=star&count=true" frameborder="0" scrolling="0" width="140px" height="20px"></iframe> </div>  -->
                    <div class="footer-block author">
                        <ul>
                            <li> Standard Version just $99 only<a href="https://hrmsoftworks.com" target="_blank"> HRMSoftworks {{ $ver }}</a> </li>
                            <li> <a href="{{ url('../Documentation') }}" target="_blank"><i class="fa fa-book icon"></i>{{ trans('lang.documentation')}}</a> </li>
                             | <strong>{{ $brand }}</strong>
                        </ul>
                    </div>
                </footer> 
